= Procedural vs Declarative Abstractions
:title: Procedural vs Declarative Abstractions | Arthur Ozga
:author: Arthur Ozga
:revdate: 2025-12-05
:docinfo: shared
:stem: latexmath
...
interface+++<sup><a href="#fn-f" id="ref-f">[f]</a></sup>+++:
...
possibility of collisions+++<sup><a href="#fn-g" id="ref-g">[g]</a></sup>+++.
...
cases+++<sup><a href="#fn-h" id="ref-h">[h]</a></sup>+++,
